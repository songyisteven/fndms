        ...
        <div id="loginbox">      
            <s:form action="admin_login.Q" namespace="/admin" method="POST" onsubmit="return checkLogin();" id="lgForm">
				  ...
				  <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                           <span style="color: #FFF;font-family: Microsoft YaHei, simsun; font-size: 24pt">法诺分销管理系统</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"></i></span><input name="user.username" id="loginName" type="text" placeholder="Username" />
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span><input name="user.password" id="loginPassword"  type="password" placeholder="Password" />
